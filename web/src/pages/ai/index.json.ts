...
export const GET: APIRoute = () => {
  ...
  const payload = {
    ...
    description: 'Amendments to specifications and constitutional documents — typed proposal, ratification, revocation, and effective-date primitives.',
    ...
    catalog: {
      ...
      exports_url: 'https://amendment-atoms.com/exports/catalog.json',
    },
    endpoints: {
      atoms: 'https://amendment-atoms.com/atoms/',
      exports: 'https://amendment-atoms.com/exports/catalog.json',
      ai_discovery: 'https://amendment-atoms.com/ai/index.json',
    },
    workflow: [
